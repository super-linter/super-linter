...
run_test_case_additional_installs_ruby_bundler() {
  ...
  cp -v "test/data/install-dependencies/additional-ruby-deps/.ruby-lint.yml" "${LINTERS_CONFIGURATION_DIRECTORY}/"
  cp -v "test/data/install-dependencies/additional-ruby-deps/os-packages.json" "${LINTERS_CONFIGURATION_DIRECTORY}/"
