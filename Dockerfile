...
FROM python:3.13.5-alpine3.21 AS clang-format
...
FROM python:3.13.5-alpine3.21 AS python-builder
...
FROM python:3.13.5-alpine3.21 AS lintr-installer
...
FROM python:3.13.5-alpine3.21 AS ruby-installer
...
FROM python:3.13.5-alpine3.21 AS base_image
