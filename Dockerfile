...
FROM python:3.12.6-alpine3.20 AS clang-format
...
FROM python:3.12.6-alpine3.20 AS python-builder
...
FROM python:3.12.6-alpine3.20 AS npm-builder
...
FROM python:3.12.6-alpine3.20 AS lintr-installer
...
FROM python:3.12.6-alpine3.20 AS base_image
