...
| **TYPESCRIPT_STANDARD_CONFIG_FILE** | `.eslintrc.ts-standard.yml`     | Filename for [eslint configuration](https://eslint.org/docs/user-guide/configuring#configuration-file-formats) in ts-standard (ex: `.eslintrc.yml`, `.eslintrc.json`)                                                |
| **TYPESCRIPT_STANDARD_TSCONFIG_FILE** | `tsconfig.json`                 | Filename for [TypeScript configuration](https://www.typescriptlang.org/docs/handbook/tsconfig-json.html) (ex: `tsconfig.json`, `tsconfig.eslint.json`)                                                               |
