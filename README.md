...
| **Fortran**                           | [fprettify](https://github.com/pseewald/fprettify)                                                                                                                                                                        |                                                                                                                    |
...
| **VALIDATE_FORTRAN_FPRETTIFY**                         | `true`                                                                       | Flag to enable or disable the linting process of Fortran files using fprettify.                                                                                                                                                                                                                                                                                             |
