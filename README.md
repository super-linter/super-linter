...
| **Secrets**                      | [Secretlint](https://github.com/secretlint/secretlint)                                                                                                                        |
...
| **SECRET_CONFIG_FILE**             | `.secretlintrc.json`            | Filename for [Secretlint configuration](https://github.com/secretlint/secretlint#configuration) (ex: `.secretlintrc.json`)                                                                                           |
...
| **VALIDATE_SECRET**                | `true`                          | Flag to enable or disable the linting process of the secrets.                                                                                                                                                        |
