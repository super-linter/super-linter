...
| **Links**                         | [lychee](https://github.com/lycheeverse/lychee)                                                                                                                                                                           | N/A                                                                                                                |
...
| **LYCHEE_CONFIG_FILE**                          | `lychee.toml`                                                                | Filename for [lychee configuration](https://github.com/lycheeverse/lychee)                                                                                                                                                                                                                                                           |
...
| **VALIDATE_LUA**                                | `true`                                                                       | Flag to enable or disable the linting process of the Lua language.                                                                                                                                                                                                                                                                   |
| **VALIDATE_LYCHEE**                             | `true`                                                                       | Flag to enable or disable the linting process of links with lychee.                                                                                                                                                                                                                                                                  |
