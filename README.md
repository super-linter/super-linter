...
| **SQL**                          | [sql-lint](https://github.com/joereynolds/sql-lint) / [tsqllint](https://github.com/tsqllint/tsqllint)                                                                         |
...
| **VALIDATE_SQL**                   | `true`                | Flag to enable or disable the linting process of the SQL language. (Utilizing: sql-lint)                                                                                         |
| **VALIDATE_SQL_TSQL**              | `true`                | Flag to enable or disable the linting process of the SQL language. (Utilizing: tsqllint)                                                                                         |
