...
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| **AI agent instructions**             | [LintLang](https://github.com/hermes-labs-ai/lintlang)                                                                                                                                                                    |                                                                                                                    |
...
| ------------------------------------------------------- | ---------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **AI_LINTLANG_COMMAND_ARGS**                            | not set                                                                      | Additional arguments to pass to the `lintlang scan` command, such as `--patterns`, `--baseline`, or `--min-severity`.                                                                                                                                                                                                                                                       |
...
| **VALIDATE_AI_LINTLANG**                                | `true`                                                                       | Flag to enable or disable linting AI agent instructions, tool definitions, and prompt files with LintLang.                                                                                                                                                                                                                                                                  |
...
- LintLang, because it detects AI agent instructions, tool definitions, and
  prompt files across the workspace.
...
- [LintLang](https://github.com/hermes-labs-ai/lintlang) (`.lintlangignore`)
