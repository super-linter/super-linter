...
| **CLANG_CONFIG_FILE**              | `.clang-format`                 | Filename for [clang-format configuration](https://clang.llvm.org/docs/ClangFormatStyleOptions.html) (ex: `.clang-format`                                                                                             |
...
| **VALIDATE_CLANG**                 | `true`                          | Flag to enable or disable the linting process of the C++/C language with clang.                                                                                                                                      |
