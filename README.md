...
| **PowerShell**                        | [PSScriptAnalyzer](https://github.com/PowerShell/Psscriptanalyzer)                                                                                                                                                        | [PSScriptAnalzyer] has built-in formatting via the `Invoke-Formatter` cmdlet that can be called in a PowerShell Script.                                                                                                                  |
