...
| **GitHub Actions**               | [actionslint](https://github.com/rhysd/actionlint)                                                                                                                            |
...
| **ACTIONS_CONFIG_FILE**            | `.actionlint.yml`               | Filename for [Actionlint configuration](https://github.com/rhysd/actionlint#configuration-file) (ex: `actionlint.yml`)                                                                                               |
...
| **VALIDATE_ACTIONS**               | `true`                          | Flag to enable or disable the linting process of the GitHub Actions.                                                                                                                                                 |
