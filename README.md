...
| **FIX_JUPYTER_NBQA_BLACKEN_DOCS**               | `false`                                                                      | Option to enable fix mode for `NBQA_BLACKEN_DOCS`.                                                                                                                                                                                                                                                                                   |
...
| **JUPYTER_NBQA_CONFIG_FILE**                    | `.jupyter-nbqa.toml`                                                         | Filename for [nbqa configuration](https://nbqa.readthedocs.io/en/latest/configuration.html) (ex: `.isort.cfg`, `pyproject.toml`)                                                                                                                                                                                                     |
...
| **VALIDATE_JUPYTER_NBQA_BLACKEN_DOCS**          | `true`                                                                       | Flag to enable or disable the linting process of Jupyter Notebooks. (Utilizing: nbqa blacken-docs)                                                                                                                                                                                                                                   |
