...
| **Shell**                             | [ShellCheck](https://github.com/koalaman/shellcheck), [Shellharden](https://github.com/anordal/shellharden), `executable bit check`                                                                                       | [shfmt](https://github.com/mvdan/sh)                                                                               |
...
| **FIX_SHELL_SHELLHARDEN**                              | `false`                                                                      | Option to enable fix mode for `SHELL_SHELLHARDEN`.                                                                                                                                                                                                                                                                                                                          |
...
| **VALIDATE_SHELL_SHELLHARDEN**                         | `true`                                                                       | Flag to enable or disable the linting process of Shell scripts. (Utilizing: shellharden)                                                                                                                                                                                                                                                                                    |
