...
| **Unicode Control**              | [find-unicode-control](https://github.com/siddhesh/find-unicode-control)                                                                                                      |
...
| **UNICODE_CONTROL_CONFIG_FILE**     | `unicode_control_config.py`     | Filename for [find-unicode-control configuration](https://github.com/siddhesh/find-unicode-control#configuration-file) (ex: `unicode_control_config.py`)                                                             |
