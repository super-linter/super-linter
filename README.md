...
| **GO_DIRECTORY**                                | empty                           | Path to the directory of a Go project to lint, relative to `DEFAULT_WORKSPACE`.                                                                                                                                      |
...
| **VALIDATE_GO_DIRECTORY**                       | `true`                          | Flag to enable or disable the linting process of a directory containing a Golang project.                                                                                                                            |
