...
| **Azure Bicep**                       | [bicep lint](https://learn.microsoft.com/en-us/azure/azure-resource-manager/bicep/bicep-cli?tabs=bicep-cli#lint)                                                                                                                                 | [bicep format](https://learn.microsoft.com/en-us/azure/azure-resource-manager/bicep/bicep-cli?tabs=bicep-cli#format)     |
...
| **VALIDATE_BICEP**                                      | `true`                                                                       | Flag to enable or disable the linting process of the BICEP language. The Bicep configuration file must be in the same directory or a parent directory of your Bicep files, otherwise default linter rules will be used.  See [Bicep file resolution docs](https://learn.microsoft.com/en-us/azure/azure-resource-manager/bicep/bicep-config#understand-the-file-resolution-process)                                                                                                                                                                                                                                                                                                         |
