...
| **TYPESCRIPT_STANDARD_CONFIG_FILE** | `.eslintrc.ts-standard.yml`    | Filename for [ESLint configuration](https://eslint.org/docs/user-guide/configuring#configuration-file-formats) in [ts-standard](https://github.com/standard/ts-standard) (ex: `.eslintrc.yml`, `.eslintrc.json`)     |
