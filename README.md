...
| **FIX_JSONC_PRETTIER**                          | `true`                                                                       | Option to enable fix mode for JSONC and JSON5 files with Prettier.                                                                                                                                                                                                                                                                   |
| **FIX_JSX_PRETTIER**                            | `true`                                                                       | Option to enable fix mode for JSX files with Prettier.                                                                                                                                                                                                                                                                               |
...
| **FIX_MARKDOWN_PRETTIER**                       | `true`                                                                       | Option to enable fix mode for Markdown files with Prettier.                                                                                                                                                                                                                                                                          |
