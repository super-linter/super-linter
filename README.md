...
| **FIX_NBQA_BLACK**                              | `false`                                                                      | Option to enable fix mode for `NBQA_BLACK`.                                                                                                                                                                                                                                                                                          |
| **FIX_NBQA_BLACKEN_DOCS**                       | `false`                                                                      | Option to enable fix mode for `NBQA_BLACKEN_DOCS`.                                                                                                                                                                                                                                                                                   |
| **FIX_NBQA_ISORT**                              | `false`                                                                      | Option to enable fix mode for `NBQA_ISORT`.                                                                                                                                                                                                                                                                                          |
| **FIX_NBQA_RUFF**                               | `false`                                                                      | Option to enable fix mode for `NBQA_RUFF`.                                                                                                                                                                                                                                                                                           |
...
| **NBQA_CONFIG_FILE**                            | `.nbqa.toml`                                                                      | Filename for [nbqa configuration](https://nbqa.readthedocs.io/en/latest/configuration.html) (ex: `.isort.cfg`, `pyproject.toml`)                                                                                                                                                                                                     |
...
| **VALIDATE_NBQA_BLACK**                         | `true`                                                                       | Flag to enable or disable the linting process of Jupyter Notebooks. (Utilizing: nbqa black)                                                                                                                                                                                                                                          |
| **VALIDATE_NBQA_BLACKEN_DOCS**                  | `true`                                                                       | Flag to enable or disable the linting process of Jupyter Notebooks. (Utilizing: nbqa blacken-docs)                                                                                                                                                                                                                                   |
| **VALIDATE_NBQA_FLAKE8**                        | `true`                                                                       | Flag to enable or disable the linting process of Jupyter Notebooks. (Utilizing: nbqa flake8)                                                                                                                                                                                                                                         |
| **VALIDATE_NBQA_ISORT**                         | `true`                                                                       | Flag to enable or disable the linting process of Jupyter Notebooks. (Utilizing: nbqa isort)                                                                                                                                                                                                                                          |
| **VALIDATE_NBQA_MYPY**                          | `true`                                                                       | Flag to enable or disable the linting process of Jupyter Notebooks. (Utilizing: nbqa mypy)                                                                                                                                                                                                                                           |
| **VALIDATE_NBQA_PYLINT**                        | `true`                                                                       | Flag to enable or disable the linting process of Jupyter Notebooks. (Utilizing: nbqa pylint)                                                                                                                                                                                                                                         |
| **VALIDATE_NBQA_RUFF**                          | `true`                                                                       | Flag to enable or disable the linting process of Jupyter Notebooks. (Utilizing: nbqa ruff)                                                                                                                                                                                                                                           |
