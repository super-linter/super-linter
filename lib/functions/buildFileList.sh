...
BuildFileArrays() {
  ...
  for FILE in "${RAW_FILE_ARRAY[@]}"; do
    ...
    if IsValidShellScript "${FILE}"; then
      ...
      IsNotSymbolicLink "${FILE}" && echo "${FILE}" >>"${FILE_ARRAYS_DIRECTORY_PATH}/file-array-CSS_PRETTIER"
    ...
    # Use BASE_FILE here because FILE_TYPE is not reliable when there is no file extension
      ...
      IsNotSymbolicLink "${FILE}" && echo "${FILE}" >>"${FILE_ARRAYS_DIRECTORY_PATH}/file-array-HTML_PRETTIER"
      ...
      IsNotSymbolicLink "${FILE}" && echo "${FILE}" >>"${FILE_ARRAYS_DIRECTORY_PATH}/file-array-JAVASCRIPT_PRETTIER"
    elif [ "$FILE_TYPE" == "jsonc" ] || [ "$FILE_TYPE" == "json5" ]; then
      echo "${FILE}" >>"${FILE_ARRAYS_DIRECTORY_PATH}/file-array-JSONC"
      IsNotSymbolicLink "${FILE}" && echo "${FILE}" >>"${FILE_ARRAYS_DIRECTORY_PATH}/file-array-JSONC_PRETTIER"
    elif [ "${FILE_TYPE}" == "json" ]; then
      echo "${FILE}" >>"${FILE_ARRAYS_DIRECTORY_PATH}/file-array-JSON"
      IsNotSymbolicLink "${FILE}" && echo "${FILE}" >>"${FILE_ARRAYS_DIRECTORY_PATH}/file-array-JSON_PRETTIER"
      ...
      IsNotSymbolicLink "${FILE}" && echo "${FILE}" >>"${FILE_ARRAYS_DIRECTORY_PATH}/file-array-JSX_PRETTIER"
      ...
      IsNotSymbolicLink "${FILE}" && echo "${FILE}" >>"${FILE_ARRAYS_DIRECTORY_PATH}/file-array-MARKDOWN_PRETTIER"
      ...
      IsNotSymbolicLink "${FILE}" && echo "${FILE}" >>"${FILE_ARRAYS_DIRECTORY_PATH}/file-array-TYPESCRIPT_PRETTIER"
      ...
      IsNotSymbolicLink "${FILE}" && echo "${FILE}" >>"${FILE_ARRAYS_DIRECTORY_PATH}/file-array-GRAPHQL_PRETTIER"
    elif [ "${FILE_TYPE}" == "vue" ]; then
      IsNotSymbolicLink "${FILE}" && echo "${FILE}" >>"${FILE_ARRAYS_DIRECTORY_PATH}/file-array-VUE_PRETTIER"
      ...
      IsNotSymbolicLink "${FILE}" && echo "${FILE}" >>"${FILE_ARRAYS_DIRECTORY_PATH}/file-array-YAML_PRETTIER"
