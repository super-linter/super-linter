...
# shellcheck disable=SC2034  # Variable is referenced indirectly
CLANG_FORMAT_FILE_NAME="${CLANG_FORMAT_CONFIG_FILE:-.clang-format}"
# shellcheck disable=SC2034  # Variable is referenced indirectly
...
LINTER_COMMANDS_ARRAY['CLANG_FORMAT']="clang-format --Werror --dry-run --style ${CLANG_FORMAT_LINTER_RULES}"
