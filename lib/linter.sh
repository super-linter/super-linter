...
# shellcheck disable=SC2034  # Variable is referenced indirectly
SECRET_FILE_NAME="${SECRET_CONFIG_FILE:-.secretlintrc.json}"
# shellcheck disable=SC2034  # Variable is referenced indirectly
...
LANGUAGE_ARRAY=('ANSIBLE' 'ARM' 'BASH' 'BASH_EXEC' 'CLANG_FORMAT'
  ...
  'RUST_2015' 'RUST_2018' 'RUST_CLIPPY' 'SECRET' 'SHELL_SHFMT' 'SNAKEMAKE_LINT'
...
LINTER_NAMES_ARRAY['SECRET']="secretlint"
...
LINTER_COMMANDS_ARRAY['SECRET']="npx secretlint --secretlintrc ${SECRET_LINTER_RULES}"
