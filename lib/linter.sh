...
LANGUAGE_ARRAY=('ANSIBLE' 'ARM' 'BASH' 'BASH_EXEC' 'CLANG_FORMAT'
  ...
  'RUST_2021' 'RUST_CLIPPY' 'SCALAFMT' 'SEMGREP' 'SHELL_SHFMT' 'SNAKEMAKE_LINT'
...
LINTER_NAMES_ARRAY['UNICODE_CONTROL']="find_unicode_control2.py"
...
LINTER_COMMANDS_ARRAY['GITLEAKS']="gitleaks -q -c ${GITLEAKS_LINTER_RULES} --no-git --redact ${LINTER_OPTS[GITLEAKS]}"
