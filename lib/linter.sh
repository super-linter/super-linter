...
LANGUAGE_ARRAY=('ANSIBLE' 'ARM' 'BASH' 'BASH_EXEC' 'CLOUDFORMATION' 'CLOJURE' 'COFFEESCRIPT' 'CSHARP' 'CSS'
  ...
  'TSQL' 'TEKTON' 'TERRAFORM' 'TERRAFORM_TERRASCAN' 'TERRAGRUNT' 'TSX' 'TYPESCRIPT_ES' 'TYPESCRIPT_STANDARD' 'XML' 'YAML')
...
LINTER_NAMES_ARRAY['TSQL']="tsqllint"
...
LINTER_COMMANDS_ARRAY['TSQL']="tsqllint --config ${TSQL_LINTER_RULES}"
