...
LINTER_DEFAULT_OPTIONS_ARRAY['GITHUB_ACTIONS']="-config-file ${GITHUB_ACTIONS_LINTER_RULES}"
...
LINTER_DEFAULT_OPTIONS_ARRAY['JSON']="eslint --no-eslintrc -c ${JAVASCRIPT_ES_LINTER_RULES} --ext .json"
...
LINTER_DEFAULT_OPTIONS_ARRAY['SQLFLUFF']=""
...
LINTER_COMMANDS_ARRAY['CLANG_FORMAT']="clang-format ${CLANG_FORMAT_LINTER_COMMAND_OPTIONS}"
...
LINTER_COMMANDS_ARRAY['GITHUB_ACTIONS']="actionlint ${GITHUB_ACTIONS_LINTER_COMMAND_OPTIONS}"
...
LINTER_COMMANDS_ARRAY['JSON']="eslint ${JSON_LINTER_COMMAND_OPTIONS}"
...
LINTER_COMMANDS_ARRAY['SQLFLUFF']="sqlfluff lint ${SQLFLUFF_LINTER_COMMAND_OPTIONS}"
