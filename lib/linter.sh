...
# shellcheck disable=SC2034  # Variable is referenced indirectly
JAVASCRIPT_ES_FILE_NAME="${JAVASCRIPT_ES_CONFIG_FILE:-.eslintrc.yaml}"
# shellcheck disable=SC2034  # Variable is referenced indirectly
JAVASCRIPT_STANDARD_FILE_NAME="${JAVASCRIPT_ES_CONFIG_FILE:-.eslintrc.yaml}"
# shellcheck disable=SC2034  # Variable is referenced indirectly
JSX_FILE_NAME="${JAVASCRIPT_ES_CONFIG_FILE:-.eslintrc.yaml}"
# shellcheck disable=SC2034  # Variable is referenced indirectly
LATEX_FILE_NAME=".chktexrc"
# shellcheck disable=SC2034  # Variable is referenced indirectly
LUA_FILE_NAME=".luacheckrc"
# shellcheck disable=SC2034  # Variable is referenced indirectly
MARKDOWN_FILE_NAME="${MARKDOWN_CONFIG_FILE:-.markdown-lint.yaml}"
# shellcheck disable=SC2034  # Variable is referenced indirectly
OPENAPI_FILE_NAME=".openapirc.yaml"
# shellcheck disable=SC2034  # Variable is referenced indirectly
...
# shellcheck disable=SC2034  # Variable is referenced indirectly
PROTOBUF_FILE_NAME=".protolintrc.yaml"
# shellcheck disable=SC2034  # Variable is referenced indirectly
...
R_FILE_NAME=".lintr"
# shellcheck disable=SC2034  # Variable is referenced indirectly
RUBY_FILE_NAME="${RUBY_CONFIG_FILE:-.ruby-lint.yaml}"
# shellcheck disable=SC2034  # Variable is referenced indirectly
...
# shellcheck disable=SC2034  # Variable is referenced indirectly
TSX_FILE_NAME="${TYPESCRIPT_ES_CONFIG_FILE:-.eslintrc.yaml}"
# shellcheck disable=SC2034  # Variable is referenced indirectly
TYPESCRIPT_ES_FILE_NAME="${TYPESCRIPT_ES_CONFIG_FILE:-.eslintrc.yaml}"
# shellcheck disable=SC2034  # Variable is referenced indirectly
TYPESCRIPT_STANDARD_FILE_NAME="${TYPESCRIPT_ES_CONFIG_FILE:-.eslintrc.yaml}"
# shellcheck disable=SC2034  # Variable is referenced indirectly
YAML_FILE_NAME="${YAML_CONFIG_FILE:-.yaml-lint.yaml}"
...
for LANGUAGE in "${LANGUAGE_ARRAY[@]}"; do
  ...
  if [ "${VALIDATE_LANGUAGE_VARIABLE_VALUE}" = "true" ]; then
    ...
    if [ "${LANGUAGE}" = "ANSIBLE" ]; then
      ...
      LANGUAGE_FILE_ARRAY_NAME="${FILE_ARRAY_VARIABLE_NAME}"[@]
      LANGUAGE_FILE_ARRAY=("${!LANGUAGE_FILE_ARRAY_NAME}")
