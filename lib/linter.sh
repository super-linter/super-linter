...
# shellcheck disable=SC2034  # Variable is referenced indirectly
SWIFT_FILE_NAME="${SWIFT_CONFIG_FILE:-/.swift-format}"
# shellcheck disable=SC2034  # Variable is referenced indirectly
...
LANGUAGE_ARRAY=('ANSIBLE' 'ARM' 'BASH' 'BASH_EXEC' 'CLANG_FORMAT'
  ...
  'SNAKEMAKE_LINT' 'SNAKEMAKE_SNAKEFMT' 'STATES' 'SQL' 'SQLFLUFF' 'SWIFT' 'TEKTON'
...
LINTER_NAMES_ARRAY['SWIFT']="swift-format"
...
LINTER_COMMANDS_ARRAY['SWIFT']="swift-format lint --configuration ${SWIFT_LINTER_RULES} --recursive ."
