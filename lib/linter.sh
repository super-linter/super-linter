...
# Editorconfig Vars
EDITORCONFIG_CHECKER_FILE_NAME="${EDITORCONFIG_CHECKER_FILE_NAME:-.ecrc}"               # Name of the file
EDITORCONFIG_LINTER_RULES="${DEFAULT_RULES_LOCATION}/${EDITORCONFIG_CHECKER_FILE_NAME}" # Path to the Editorconfig lint rules
# Golang Vars
